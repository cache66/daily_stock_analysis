...
class SignalSnapshotListItem(BaseModel):
    ...
    review_tier: Optional[str] = Field(None, description="Shortline review tier")
    composite_score: Optional[float] = Field(None, description="Shortline composite score")
    shortline_category: Optional[str] = Field(None, description="Shortline category")
    confidence_label: Optional[str] = Field(None, description="Shortline confidence label")
    short_term_view: Optional[str] = Field(None, description="Shortline short-term view")
    tracking_appear_streak_days: Optional[int] = Field(None, description="Shortline appear streak days")
    tracking_tier_transition: Optional[str] = Field(None, description="Shortline tier transition")
