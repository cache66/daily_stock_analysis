...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, ListChecks, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'personal-strategies', labelKey: 'layout.nav.personalStrategies', to: '/personal-strategies', icon: ListChecks },
