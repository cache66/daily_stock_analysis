...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "SIGNAL_SNAPSHOT_HUNDRED_DAY_HIGH_ENABLED": {
        "title": "Signal Snapshot Update",
        "description": "Run the hundred-day-high snapshot refresh after each scheduled analysis run.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SIGNAL_SNAPSHOT_HUNDRED_DAY_HIGH_CAUSE_ANALYSIS_ENABLED": {
        "title": "Signal Cause Backfill",
        "description": "Also backfill reason analysis for scheduled hundred-day-high snapshots after the fast snapshot stage.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "BOARD_RECOGNIZABILITY_SNAPSHOT_ENABLED": {
        "title": "Board Recognizability Snapshot",
        "description": "Run board recognizability TopN snapshot refresh after each scheduled analysis run.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "BOARD_RECOGNIZABILITY_SNAPSHOT_SOURCE_SIGNAL_TYPE": {
        "title": "Board Snapshot Source Signal",
        "description": "Source signal type used to build scheduled board recognizability rankings, such as hundred_day_high.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "hundred_day_high",
        "options": [],
        "validation": {},
        "display_order": 15,
    },
    "BOARD_RECOGNIZABILITY_SNAPSHOT_TOP_N": {
        "title": "Board Snapshot Top N",
        "description": "How many stocks to keep per board when the scheduled recognizability snapshot runs.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "BOARD_THEME_CORE_SNAPSHOT_ENABLED": {
        "title": "Board Snapshot Update",
        "description": "Run board/theme-core snapshot refresh after each scheduled analysis run.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "BOARD_THEME_CORE_SNAPSHOT_TARGETS_JSON": {
        "title": "Board Snapshot Targets",
        "description": "JSON array of board snapshot targets used by schedule mode, e.g. [{\"board_name\":\"CPO\",\"board_type\":\"concept\",\"commodity_hint\":\"optical_fiber\"}].",
        "category": "system",
        "data_type": "json",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "TREND_LEADER_UNIFIED_SNAPSHOT_ENABLED": {
        "title": "Trend Leader Snapshot Update",
        "description": "Run trend-leader unified daily bundle (scan + performance report) after each scheduled analysis run.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TREND_LEADER_UNIFIED_SNAPSHOT_LIMIT": {
        "title": "Trend Leader Snapshot Limit",
        "description": "Max number of symbols scanned by scheduled trend-leader daily bundle. Use 0 for full market scan.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
